function getAkanName () {
  ...
  //formula to determine DOB (Sunday = 1, Monday = 2)etc..
  let dayOfWeekNumber = Math.floor((((Number(yearOfBirth.slice(0,2))/4)-2*Number(yearOfBirth.slice(0,2))-1)+
          ((5*Number(yearOfBirth.slice(2,4))/4))+((26*(monthOfBirth+1)/10))+dayOfBirth)%7);

  //akan name arrays, male and female
  let maleAkanNames = [
  ...
  if (myGenderValue == "male" && monthValid && dayValid){
    ...
    switch (dayOfWeekNumber) {
      ...
      case 3:
        ...
        break;
      case 4:
        document.getElementById('result').textContent = "You were born on Wednesday: your Akan name is " + femaleAkanNames[3];
        document.getElementById('display-name').textContent = "Here is your Akan name: ";
        return false;
        break;
      case 5:
      ...
      case 6:
        ...
        break;
      case 7:
        document.getElementById('result').textContent = "You were born on Saturday: your Akan name is " + femaleAkanNames[6];
        document.getElementById('display-name').textContent = "Here is your Akan name: ";
        return false;
        break;
      case 0:
      ...
      alert("Invalid details (month or day)");
    }
  }